sap.ui.require([
  ...
  var sViewName = "com.infocus.TimeApproval.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.infocus.TimeApproval"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.infocus.TimeApproval"
            });
        }
      }
